          ...
          <div id="keyword-table_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
             <div class="top">
              <div class="flex">
                 <div class="dt-buttons btn-group">
                  <button class="btn btn-default" tabindex="0"
                                        aria-controls="keyword-table" type="button" id="filter" data-original-title=""
                                        title=""><span><span class="glyphicon glyphicon-filter"
                                                aria-hidden="true"></span> Filter <span class="glyphicon glyphicon-chevron-down"></span></span></button>
                </div>
                 <div id="keyword-table_filter" class="dataTables_filter">
                  <label>
                     <input type="search"
              ...
              <div class="functions">
                 <div class="dataTables_length" id="keyword-table_length">
                  <label><span id="pagechange"
                    ...
                    <!-- <i class="fas fa-circle-notch fast-spin" style="font-size: 14px;"></i> Font Awesome fontawesome.com --></span> Keywords per page:
                     <select name="keyword-table_length"
                  ...
                  <button class="btn btn-default buttons-csv buttons-html5"
                                        ...
                                        id="csv-export"><span>CSV Export <span
                                                class="glyphicon glyphicon-disk-save"></span></span></button>
                </div>
               </div>
            </div>
             <table id="keyword-table" class="table table-striped dataTable" style="width:100%" role="grid">
              <thead id="header">
                 <tr role="row">
                  ...
                  <th data-toggle="tooltip" data-placement="top"
                                        ...
                                        aria-label="Search volume: activate to sort column ascending">Search volume </th>
                  <th data-toggle="tooltip" data-placement="top"
                                        ...
                                        aria-label="Comp.: activate to sort column ascending"> Comp.</th>
                 ...
                 <tr class="subheader">
                  ...
                  <th colspan="4"> <div class="keyword-confirm-tooltip">
                      <input type="button"
              ...
              <tfoot id="footer">
                 <tr class="subheader">
                  <th colspan="5" style="text-align: right;"
                                        class="keyword-td text-align-right text-align-center" rowspan="1"> <div class="keyword-confirm-tooltip">
              ...
              <tr class="{{ $i % 2 == 0 ? 'odd' : 'even'}}">
                 ...
                 <td class="markrow sorting_1"><div class="flex" style="justify-content: space-between;">
                     <div class="progress" style="width:85px;margin:5px 0">
                      <div class="progress-bar " style="width: {{ $barPercentage ?? 0 }}%;"> </div>
                    </div>
                     <span>{{ $search ?? '' }}</span> </div></td>
                 ...
                 <td class=" text-align-center"><button class="btn btn-primary show-childrows">show <span class="glyphicon glyphicon-chevron-down"></span></button></td>
  ...
  <div class="keywordplanner-content">
     <section class="keyplan">
      ...
      <div class="row">
         ...
         <div class="col-md-6">
          <div class="key-right-box reserach-tol"> <img src="{{ asset('assets/images/digital1.jpg') }}"> </div>
        </div>
       </div>
    </section>
     <section class="keyplan-first">
      <div class="container">
         <div class="row">
          <div class="col-md-6">
             <div class="key-right-box reserach-tol "> <img src="{{ asset('assets/images/net1.png') }}"> </div>
           </div>
          <div class="col-md-6">
             <div class="key-left-box">
     ...
     <section class="keyplan-second">
      ...
      <div class="container">
         <div class="diff-key">
          <ul>
             <li>
              <div class="focs-keyword">
                 <div class="focs-keyword-img"> <img src="{{ asset('assets/images/focs1.png') }}"></div>
             ...
             <li>
              <div class="focs-keyword">
                 <div class="focs-keyword-img"> <img src="{{ asset('assets/images/seo-Visitors-Growth.png') }}"></div>
                 <div class="focs-keyword-cntnt">
                  ...
                  <p>in addition to your focus keyword,
                     ...
                     “beanie hats”,
                     you could also include in your article variations like “men’s beanie hats” or “beanie hats for women.”</p>
                </div>
               </div>
            </li>
             <li>
              <div class="focs-keyword">
                 <div class="focs-keyword-img"> <img src="{{ asset('assets/images/seo-Google-Analytics.png') }}"></div>
                 <div class="focs-keyword-cntnt">
                  ...
                  <p>keywords that relate to your focus keyword but might not contain the words that make up the phrase should also be included. As we’ll see below, these types of keywords are important in giving your article context, which helps search engines better understand what your content is about. For example, if we stick with the “beanie hat” keyword, 
                     related terms could include “woollen cap for men” or “Prada beanie”. </p>
                </div>
               </div>
            </li>
             <li>
              <div class="focs-keyword">
                 <div class="focs-keyword-img"> <img src="{{ asset('assets/images/Industry-Proven-Practices.png') }}"></div>
                 <div class="focs-keyword-cntnt">
                  <h2>Questions </h2>
                  <p> one of the main reasons people use search engines is to find answers to questions that they have. As a result, searches that begin with the likes of who, what, where and how are some of the most popular. 
                     Including these questions in your article and providing answers is a great use of your keyword research.</p>
                </div>
               </div>
            </li>
           </ul>
        </div>
         <div class="diff-key-img"> <img src="{{ asset('assets/images/digi-marktng-rocket-1.png') }}"> </div>
     ...
     <section class="web-help-rank">
      <div class="container">
         <div class="key-right-box ft-lft "> <img src="{{ asset('assets/images/case01.jpg') }}"> </div>
     ...
     <section class="key-srch-tool">
      <div class="container">
         ...
         <div class="row">
          <div class="col-md-6">
             <div class="proces-img"> <img src="{{ asset('assets/images/process_1.jpg') }}"> </div>
           </div>
          <div class="col-md-6 ">
     ...
     <div class="container">
      <div class="row">
         <div class="col-md-6">
          <div class="tol-img"> <img src="{{ asset('assets/images/features_left.png') }}">
  ...
  <section class="keyplan">
     <div class="container">
      <div class="row">
         ...
         <div class="col-md-6">
          <div class="key-right-box web-tref"> <img src="{{ asset('assets/images/home21.png') }}"> </div>
        </div>
       </div>
    </div>
   </section>
