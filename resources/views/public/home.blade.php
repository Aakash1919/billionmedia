      ...
      <div class="row">
        <div class="col-md-6">
          <div class="banner-saction-box-left">
            ...
            <p>Carry out keyword research, track your rankings and keep tabs on your competitors. Try it for free today</p>
            <div class="search">
        ...
        <div class="col-md-6">
          <div class="banner-saction-box-right"> <img src="{{ asset('assets/front/images/content_thumb.png') }}" alt="seo"> </div>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="new-boxhome-inner">
            ...
            <span>Our SEO keyword research tool is one of the core services that we offer. If you’re unfamiliar with such a tool, it’s simply a means of finding out crucial information about search terms that you’d like to target for your own website. </span> <em>The SEO Science keyword tool provides data on:</em>
            <ul>
        ...
        <div class="col-md-6">
          <div class="new-boxhome-inner"> <img src="{{ asset('assets/images/new-home-14-banner-img.png') }}"> </div>
        </div>
      </div>
    </div>
  </div>
...
<div class="saction-neww">
  <div class="container"> <span>When you <em>conduct your search,</em> you’ll be provided with other pieces of data too, such as the monthly search volume of each <em>keyword</em> and whether it has any <em>cost per click value,</em> which can be very useful if you’re planning to use <em>paid advertisements</em> such as on Google. </span>
    <div class="row">
      <div class="col-md-6">
...
<div class="post-saction-home">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-4">
        <div class="post-saction-boxxx"> <img src="{{ asset('assets/images/blog1.jpg') }}">
          ...
          <a href="#" class="read-more">Read More <img src="{{ asset('assets/front/images/right-arrow.png') }}"></a> </div>
      </div>
      <div class="col-md-4">
        <div class="post-saction-boxxx"> <img src="{{ asset('assets/images/blog2.jpg') }}">
      ...
      <div class="col-md-4">
        <div class="post-saction-boxxx"> <img src="{{ asset('assets/images/blog3.jpg') }}">
          <div class="year-date">Nov 22, 2021</div>
