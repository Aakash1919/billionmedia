    ...
    <div class="alert alert-warning border-0 bg-warning alert-dismissible fade show py-2">
      <div class="d-flex align-items-center">
        ...
        <div class="ms-3">
          ...
          <div class="text-dark">If you want to access full tools, please connect with google <a
              href="{{ route('google-authorize') }}" class="btn btn-sm btn-primary mb-2">Connect</a></div>
        </div>
      </div>
              ...
              <div class="table-price">
                <form action="{{route('keyword-planner-post')}}" method="post" class="keword-from">
                  ...
                  <div class="-kewful-side">
                    ...
                    <input type="text" name="url" list="engines" class="form-control" placeholder="Google.com">
                  </div>
